...
var _user$project$Main$outmsg = _elm_lang$core$Native_Platform.outgoingPort(
	'outmsg',
	function (v) {
		return v;
	});
var _user$project$Main$inmsg = _elm_lang$core$Native_Platform.incomingPort('inmsg', _elm_lang$core$Json_Decode$int);
var _user$project$Main$In = function (a) {
	return {ctor: 'In', _0: a};
};
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Main$TimeTick),
				_user$project$Main$inmsg(_user$project$Main$In)
			]));
};
var _user$project$Main$ResponseError = function (a) {
	return {ctor: 'ResponseError', _0: a};
};
var _user$project$Main$ResponseString = function (a) {
	return {ctor: 'ResponseString', _0: a};
};
var _user$project$Main$performGetString = function (url) {
	return A3(
		_elm_lang$core$Task$perform,
		function (x) {
			return _user$project$Main$ResponseError(x);
		},
		function (str) {
			return _user$project$Main$ResponseString(str);
		},
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'ResponseString':
				return {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Debug$log, _p0._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ResponseError':
				return {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Debug$log, 'err', model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'TimeTick':
				return {
			...
			default:
				if (_p0._0 === 1) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$performGetString('http://www.google.com')
					};
				} else {
					var _p1 = _p0._0;
					return {
