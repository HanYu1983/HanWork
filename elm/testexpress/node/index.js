...
Elm.M1 = Elm.M1 || {};
Elm.M1.make = function (_elm) {
   "use strict";
   _elm.M1 = _elm.M1 || {};
   if (_elm.M1.values) return _elm.M1.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var test = 0;
   return _elm.M1.values = {_op: _op,test: test};
};
Elm.Native.Main = {};
...
Elm.Main.make = function (_elm) {
   ...
   var send = $Native$Main.send;
   var get = $Native$Main.get;
   var listen = $Native$Main.listen;
   var Response = {ctor: "Response"};
   var Request = {ctor: "Request"};
   var main = Elm.Native.Task.make(_elm).perform(A2($Task.andThen,
   $Task.sequence(_U.list([log("get /fn1")
                          ,A2(get,"/fn1",F2(function (req,res) {    return A2(send,"hello world",res);}))
                          ,log("get /fn2")
                          ,A2(get,"/fn2",F2(function (req,res) {    return A2(send,"hello world",res);}))
                          ,log("listen 8080")
                          ,listen(8080)])),
   function (_p0) {
      return $Task.succeed({ctor: "_Tuple0"});
   }));
   return _elm.Main.values = {_op: _op,Request: Request,Response: Response,listen: listen,get: get,send: send,log: log};
};
