...
Elm.HanLib = Elm.HanLib || {};
Elm.HanLib.Tool = Elm.HanLib.Tool || {};
Elm.HanLib.Tool.make = function (_elm) {
   "use strict";
   _elm.HanLib = _elm.HanLib || {};
   _elm.HanLib.Tool = _elm.HanLib.Tool || {};
   if (_elm.HanLib.Tool.values) return _elm.HanLib.Tool.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$HanLib$Tool = Elm.Native.HanLib.Tool.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var performBackground = $Native$HanLib$Tool.performBackground;
   var alert = $Native$HanLib$Tool.alert;
...
Elm.Ask.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $HanLib$Tool = Elm.HanLib.Tool.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var Model = F5(function (a,b,c,d,e) {    return {handA: a,handB: b,commonStack: c,op: d,currUser: e};});
   var OpSelectCard = function (a) {    return {ctor: "OpSelectCard",_0: a};};
   var NoOp = {ctor: "NoOp"};
   var defaultModel = {handA: _U.list([{id: "0",selected: false},{id: "1",selected: false}])
                      ,handB: _U.list([{id: "2",selected: false}])
                      ,commonStack: _U.list([])
                      ,op: NoOp
                      ,currUser: "playerA"};
   var Card = F2(function (a,b) {    return {id: a,selected: b};});
   var OnCommited = function (a) {    return {ctor: "OnCommited",_0: a};};
   var OnLoadSingalGoal = function (a) {    return {ctor: "OnLoadSingalGoal",_0: a};};
   var OnLoadGoal = function (a) {    return {ctor: "OnLoadGoal",_0: a};};
   var OnLoadGame = function (a) {    return {ctor: "OnLoadGame",_0: a};};
   var ClickStep = {ctor: "ClickStep"};
   var ClickChangeUser = {ctor: "ClickChangeUser"};
   var ClickCommit = {ctor: "ClickCommit"};
   var ClickLoadGoal = {ctor: "ClickLoadGoal"};
   var ClickLoadGame = {ctor: "ClickLoadGame"};
   var ClickCard = function (a) {    return {ctor: "ClickCard",_0: a};};
   ...
   var view = function (model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],"user:",model.currUser))]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([function () {
                 var _p0 = model.op;
                 if (_p0.ctor === "OpSelectCard" && _p0._0.ctor === "_Tuple2") {
                       return $Html.text(A2($Basics._op["++"],
                       "OpSelectCard ",
                       A2($Basics._op["++"],$Basics.toString(_p0._0._0),A2($Basics._op["++"],",",$Basics.toString(_p0._0._1)))));
                    } else {
                       return $Html.text("no op");
                    }
              }()]))
              ,A2($Html.div,_U.list([]),_U.list([$Html.text("common-stack")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("pure-g")]),
              A2($List.map,
              function (c) {
                 return A2($Html.button,
                 _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "pure-button",_1: true}
                                                             ,{ctor: "_Tuple2",_0: "pure-button-active",_1: c.selected}]))]),
                 _U.list([$Html.text(c.id)]));
              },
              model.commonStack))
              ,A2($Html.div,_U.list([]),_U.list([$Html.text("A head")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("pure-g")]),
              A2($List.map,
              function (c) {
                 ...
                 _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "pure-button",_1: true}
                                                             ,{ctor: "_Tuple2",_0: "pure-button-active",_1: c.selected}]))
                         ,A3($Html$Events.on,"click",$Html$Events.targetValue,function (_p1) {    return A2($Signal.message,action.address,ClickCard(c));})]),
                 _U.list([$Html.text(c.id)]));
              },
              model.handA))
              ,A2($Html.div,_U.list([]),_U.list([$Html.text("B head")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("pure-g")]),
              A2($List.map,
              function (c) {
                 ...
                 _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "pure-button",_1: true}
                                                             ,{ctor: "_Tuple2",_0: "pure-button-active",_1: c.selected}]))
                         ,A3($Html$Events.on,"click",$Html$Events.targetValue,function (_p2) {    return A2($Signal.message,action.address,ClickCard(c));})]),
                 _U.list([$Html.text(c.id)]));
              },
              model.handB))
              ,A2($Html.div,_U.list([]),_U.list([$Html.text("Menu")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("pure-g")]),
              _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.$class("pure-button")
                              ,A3($Html$Events.on,
                              "click",
                              $Html$Events.targetValue,
                              function (_p3) {
                                 return A2($Signal.message,action.address,ClickCommit);
                              })]),
                      _U.list([$Html.text("commit")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("pure-button")
                              ,A3($Html$Events.on,
                              "click",
                              $Html$Events.targetValue,
                              function (_p4) {
                                 return A2($Signal.message,action.address,ClickLoadGame);
                              })]),
                      _U.list([$Html.text("load game")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("pure-button")
                              ,A3($Html$Events.on,
                              "click",
                              $Html$Events.targetValue,
                              function (_p5) {
                                 return A2($Signal.message,action.address,ClickLoadGoal);
                              })]),
                      _U.list([$Html.text("load goal")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("pure-button")
                              ,A3($Html$Events.on,
                              "click",
                              $Html$Events.targetValue,
                              function (_p6) {
                                 return A2($Signal.message,action.address,ClickChangeUser);
                              })]),
                      _U.list([$Html.text("change user")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("pure-button")
                              ,A3($Html$Events.on,"click",$Html$Events.targetValue,function (_p7) {    return A2($Signal.message,action.address,ClickStep);})]),
                      _U.list([$Html.text("step")]))]))]));
   };
   var parseOnlyError = A3($Json$Decode.tuple2,
   F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
   $Json$Decode.maybe($Json$Decode.string),
   $Json$Decode.value);
   var Goal = F3(function (a,b,c) {    return {id: a,description: b,parameters: c};});
   var parseGoalResult = A3($Json$Decode.tuple2,
   F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
   $Json$Decode.maybe($Json$Decode.string),
   $Json$Decode.list(A4($Json$Decode.object3,
   Goal,
   A2($Json$Decode._op[":="],"ID",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"Description",$Json$Decode.string),
   A2($Json$Decode._op[":="],"Parameters",$Json$Decode.list($Json$Decode.string)))));
   var parseSingalGoalResult = A3($Json$Decode.tuple2,
   F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
   $Json$Decode.maybe($Json$Decode.string),
   ...
   A2($Json$Decode._op[":="],"Description",$Json$Decode.string),
   A2($Json$Decode._op[":="],"Parameters",$Json$Decode.list($Json$Decode.string))));
   var Game = F2(function (a,b) {    return {id: a,cardStack: b};});
   var parseGameResult = A3($Json$Decode.tuple2,
   F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
   $Json$Decode.maybe($Json$Decode.string),
   ...
   A2($Json$Decode._op[":="],"Card",$Json$Decode.list(A2($Json$Decode.object1,$Basics.identity,A2($Json$Decode._op[":="],"ID",$Json$Decode.string)))))))));
   var update = F2(function (act,model) {
      var _p8 = act;
      switch (_p8.ctor)
      {case "NoAction": return model;
         case "OnCommited": var _p9 = _p8._0;
           if (_p9.ctor === "Err") {
                 return A2($HanLib$Tool.alert,_p9._0,model);
              } else {
                 var _p10 = _p9._0._0;
                 if (_p10.ctor === "Just") {
                       return A2($HanLib$Tool.alert,_p10._0,model);
                    } else {
                       return _U.update(model,
                       {op: NoOp
                       ,handA: A2($List.map,function (c) {    return _U.update(c,{selected: false});},model.handA)
                       ,handB: A2($List.map,function (c) {    return _U.update(c,{selected: false});},model.handB)});
                    }
              }
         case "OnLoadSingalGoal": var _p11 = _p8._0;
           if (_p11.ctor === "Err") {
                 return A2($HanLib$Tool.alert,_p11._0,model);
              } else {
                 var _p14 = _p11._0._1;
                 var _p12 = _p11._0._0;
                 if (_p12.ctor === "Just") {
                       return A2($HanLib$Tool.alert,_p12._0,model);
                    } else {
                       var _p13 = _p14.description;
                       if (_p13 === "select {0} cards") {
                             return _U.update(model,{op: OpSelectCard({ctor: "_Tuple2",_0: _p14.id,_1: 2})});
                          } else {
                             return model;
                          }
                    }
              }
         case "OnLoadGoal": var _p15 = _p8._0;
           if (_p15.ctor === "Err") {
                 return A2($HanLib$Tool.alert,_p15._0,model);
              } else {
                 var _p16 = _p15._0._0;
                 if (_p16.ctor === "Just") {
                       return A2($HanLib$Tool.alert,_p16._0,model);
                    } else {
                       var firstGoal = $List.head(_p15._0._1);
                       var _p17 = firstGoal;
                       if (_p17.ctor === "Nothing") {
                             return _U.update(model,{op: NoOp});
                          } else {
                             return A2($HanLib$Tool.performBackground,
                             function (_p18) {
         ...
         case "OnLoadGame": var _p19 = _p8._0;
           if (_p19.ctor === "Err") {
                 return A2($HanLib$Tool.alert,_p19._0,model);
              } else {
                 var _p30 = _p19._0._1;
                 var _p20 = _p19._0._0;
                 if (_p20.ctor === "Just") {
                       return A2($HanLib$Tool.alert,_p20._0,model);
                    } else {
                       var common = $List.head(A2($List.filter,function (_p21) {    var _p22 = _p21;return _U.eq(_p22._0,"common-stack");},_p30.cardStack));
                       var bhand = $List.head(A2($List.filter,function (_p23) {    var _p24 = _p23;return _U.eq(_p24._0,"B-hand");},_p30.cardStack));
                       var ahand = $List.head(A2($List.filter,function (_p25) {    var _p26 = _p25;return _U.eq(_p26._0,"A-hand");},_p30.cardStack));
                       return _U.update(model,
                       {handA: function () {
                          var _p27 = ahand;
                          if (_p27.ctor === "Nothing") {
                                ...
                                return A2($List.map,function (id) {    return A2(Card,id,false);},_p27._0._2);
                             }
                       }()
                       ,handB: function () {
                          var _p28 = bhand;
                          if (_p28.ctor === "Nothing") {
                                ...
                                return A2($List.map,function (id) {    return A2(Card,id,false);},_p28._0._2);
                             }
                       }()
                       ,commonStack: function () {
                          var _p29 = common;
                          if (_p29.ctor === "Nothing") {
                                return model.commonStack;
                             } else {
                                return A2($List.map,function (id) {    return A2(Card,id,false);},_p29._0._2);
                             }
                       }()});
                    }
              }
         case "ClickStep": return A2($HanLib$Tool.performBackground,
           function (_p31) {
              return A3(callUrlAndDecodeAndSendAction,
              parseGameResult,
              OnLoadGame,
         ...
         case "ClickCommit": return A2($HanLib$Tool.performBackground,
           function (_p32) {
              var _p33 = model.op;
              if (_p33.ctor === "OpSelectCard" && _p33._0.ctor === "_Tuple2") {
                    var hand = function () {
                       var _p34 = model.currUser;
                       switch (_p34)
                       {case "playerA": return model.handA;
                          case "playerB": return model.handB;
                          default: return model.handA;}
                    }();
                    var selected = A2($List.filter,function (_) {    return _.selected;},hand);
                    return !_U.eq($List.length(selected),_p33._0._1) ? A2($HanLib$Tool.alert,
                    "select 2 card",
                    $Task.succeed({ctor: "_Tuple0"})) : A3(callUrlAndDecodeAndSendAction,
                    parseOnlyError,
                    OnCommited,
                    A2($Http.url,
           ...
           model);
         case "ClickLoadGoal": return A2($HanLib$Tool.performBackground,
           function (_p35) {
              return A3(callUrlAndDecodeAndSendAction,
              parseGoalResult,
              OnLoadGoal,
         ...
         default: var _p38 = _p8._0;
           ...
           if (_p37.ctor === "NoOp") {
                 ...
                 return _U.update(model,
                 {handA: A2($List.map,function (c) {    return _U.eq(c,_p38) ? _U.update(c,{selected: _U.eq(c.selected,true) ? false : true}) : c;},model.handA)
                 ,handB: A2($List.map,
                 function (c) {
                    return _U.eq(c,_p38) ? _U.update(c,{selected: _U.eq(c.selected,true) ? false : true}) : c;
                 },
                 model.handB)});
              }}
   });
