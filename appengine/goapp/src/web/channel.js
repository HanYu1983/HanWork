...
Elm.Channel = Elm.Channel || {};
Elm.Channel.make = function (_elm) {
   "use strict";
   _elm.Channel = _elm.Channel || {};
   if (_elm.Channel.values) return _elm.Channel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Channel = Elm.Native.Channel.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   ...
   F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
   $Json$Decode.oneOf(_U.list([$Json$Decode.$null($Maybe.Nothing),A2($Json$Decode.map,$Maybe.Just,$Json$Decode.string)])),
   $Json$Decode.value);
   var parseUserResult = A3($Json$Decode.tuple2,
   F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),
   $Json$Decode.oneOf(_U.list([$Json$Decode.$null($Maybe.Nothing),A2($Json$Decode.map,$Maybe.Just,$Json$Decode.string)])),
   $Json$Decode.string);
   var defaultModel = {user: "",token: "",msg: "",msgs: _U.list([])};
   var Model = F4(function (a,b,c,d) {    return {user: a,token: b,msg: c,msgs: d};});
   var OnMessage = function (a) {    return {ctor: "OnMessage",_0: a};};
   var SendAction = function (a) {    return {ctor: "SendAction",_0: a};};
   var LoginAction = function (a) {    return {ctor: "LoginAction",_0: a};};
   var ClickSendMessage = {ctor: "ClickSendMessage"};
   var ClickLoginAction = {ctor: "ClickLoginAction"};
   var InputMessageAction = function (a) {    return {ctor: "InputMessageAction",_0: a};};
   var InputNameAction = function (a) {    return {ctor: "InputNameAction",_0: a};};
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([$Html$Attributes.$class("form-control")
                              ,A3($Html$Events.on,"keyup",$Html$Events.targetValue,A2(sendAction,action.address,InputNameAction))]),
                      _U.list([]))]))
                      ,A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html.div,
                              ...
                              _U.list([A2($Html.input,
                              _U.list([$Html$Attributes.$class("form-control")
                                      ,A3($Html$Events.on,"keyup",$Html$Events.targetValue,A2(sendAction,action.address,InputMessageAction))]),
                              _U.list([]))]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("col-sm-2")]),
                              _U.list([A2($Html.button,
   ...
   return _elm.Channel.values = {_op: _op
                                ...
                                ,ClickLoginAction: ClickLoginAction
