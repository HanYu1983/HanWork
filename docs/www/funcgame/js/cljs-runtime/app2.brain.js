...
app2.brain.updateQ = (function app2$brain$updateQ(p__37480,state,action,actions){
var map__37481 = p__37480;
var map__37481__$1 = (((((!((map__37481 == null))))?(((((map__37481.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37481.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37481):map__37481);
var self = map__37481__$1;
var lastState = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37481__$1,new cljs.core.Keyword(null,"lastState","lastState",767733421));
var lastAction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37481__$1,new cljs.core.Keyword(null,"lastAction","lastAction",-1557545249));
var q = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37481__$1,new cljs.core.Keyword(null,"q","q",689001697));
...
return nextQ;
});})(map__37481,map__37481__$1,self,lastState,lastAction,q))
...
var scores = cljs.core.replace.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 1, [null,(0)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37504_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(self,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),state,p1__37504_SHARP_], null));
}),actions));
return scores;
});
...
var scores = cljs.core.replace.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 1, [null,(0)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37542_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(self,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),state,p1__37542_SHARP_], null));
}),actions));
...
var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37545,(0),null);
var score = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37545,(1),null);
...
var scores = cljs.core.replace.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 1, [null,(0)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37549_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(self,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),state,p1__37549_SHARP_], null));
}),actions));
var best = cljs.core.ffirst(cljs.core.sort.cljs$core$IFn$_invoke$arity$2(((function (scores){
return (function (p1__37551_SHARP_,p2__37550_SHARP_){
return cljs.core.compare(cljs.core.last(p2__37550_SHARP_),cljs.core.last(p1__37551_SHARP_));
});})(scores))
