...
cljs.spec.alpha.def_impl(new cljs.core.Keyword("app.t8.qlearning","model","app.t8.qlearning/model",-618351263),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","keys","cljs.spec.alpha/keys",1109346032,null),new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app.t8.qlearning","qtable","app.t8.qlearning/qtable",-806349188),new cljs.core.Keyword("app.t8.qlearning","learningRate","app.t8.qlearning/learningRate",1990319207),new cljs.core.Keyword("app.t8.qlearning","discountFactor","app.t8.qlearning/discountFactor",-189291223)], null)),cljs.spec.alpha.map_spec_impl(cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app.t8.qlearning","qtable","app.t8.qlearning/qtable",-806349188),new cljs.core.Keyword("app.t8.qlearning","learningRate","app.t8.qlearning/learningRate",1990319207),new cljs.core.Keyword("app.t8.qlearning","discountFactor","app.t8.qlearning/discountFactor",-189291223)], null),null,null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__29112){
return cljs.core.map_QMARK_(G__29112);
}),(function (G__29112){
return cljs.core.contains_QMARK_(G__29112,new cljs.core.Keyword(null,"qtable","qtable",-1752712086));
}),(function (G__29112){
return cljs.core.contains_QMARK_(G__29112,new cljs.core.Keyword(null,"learningRate","learningRate",2143591057));
}),(function (G__29112){
return cljs.core.contains_QMARK_(G__29112,new cljs.core.Keyword(null,"discountFactor","discountFactor",206790427));
})], null),(function (G__29112){
return ((cljs.core.map_QMARK_(G__29112)) && (cljs.core.contains_QMARK_(G__29112,new cljs.core.Keyword(null,"qtable","qtable",-1752712086))) && (cljs.core.contains_QMARK_(G__29112,new cljs.core.Keyword(null,"learningRate","learningRate",2143591057))) && (cljs.core.contains_QMARK_(G__29112,new cljs.core.Keyword(null,"discountFactor","discountFactor",206790427))));
...
app.t8.qlearning.model = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"qtable","qtable",-1752712086),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"learningRate","learningRate",2143591057),(1),new cljs.core.Keyword(null,"discountFactor","discountFactor",206790427),(1)], null);
...
app.t8.qlearning.learn = (function app$t8$qlearning$learn(p__29113,state,action,reward,newState){
var map__29114 = p__29113;
var map__29114__$1 = (((((!((map__29114 == null))))?(((((map__29114.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29114.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29114):map__29114);
var ctx = map__29114__$1;
var learningRate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29114__$1,new cljs.core.Keyword(null,"learningRate","learningRate",2143591057));
var discountFactor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29114__$1,new cljs.core.Keyword(null,"discountFactor","discountFactor",206790427));
...
var _PERCENT_ = cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(ctx,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"qtable","qtable",-1752712086),state,action], null),((function (map__29114,map__29114__$1,ctx,learningRate,discountFactor){
...
return nextQ;
});})(map__29114,map__29114__$1,ctx,learningRate,discountFactor))
);
...
var scores = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29116_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ctx,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"qtable","qtable",-1752712086),state,p1__29116_SHARP_], null));
}),actions);
...
var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29118,(0),null);
var score = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29118,(1),null);
...
var scores = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29121_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(self,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"qtable","qtable",-1752712086),state,p1__29121_SHARP_], null));
}),actions);
var best = cljs.core.ffirst(cljs.core.sort.cljs$core$IFn$_invoke$arity$2(((function (scores){
return (function (p1__29123_SHARP_,p2__29122_SHARP_){
return cljs.core.compare(cljs.core.second(p2__29122_SHARP_),cljs.core.second(p1__29123_SHARP_));
});})(scores))
