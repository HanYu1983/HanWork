...
var G__35883 = o;
(G__35883[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__35990__delegate = function (args){
...
while (G__35991__i < G__35991__a.length) {G__35991__a[G__35991__i] = arguments[G__35991__i + 0]; ++G__35991__i;}
  args = new cljs.core.IndexedSeq(G__35991__a,0,null);
} 
return G__35990__delegate.call(this,args);};
...
return G__35990__delegate(args);
});
...
var G__35890 = o;
(G__35890[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36000__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__36001__i < G__36001__a.length) {G__36001__a[G__36001__i] = arguments[G__36001__i + 0]; ++G__36001__i;}
  args = new cljs.core.IndexedSeq(G__36001__a,0,null);
} 
return G__36000__delegate.call(this,args);};
G__36000.cljs$lang$maxFixedArity = 0;
G__36000.cljs$lang$applyTo = (function (arglist__36002){
var args = cljs.core.seq(arglist__36002);
return G__36000__delegate(args);
});
...
var G__35900 = props;
var G__35900__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35900,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35900);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35900__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__35901){
...
var props = map__35902__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35902__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__35902,map__35902__$1,props,class$){
return (function (c){
...
});})(map__35902,map__35902__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__35907){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35908__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__35908,map__35908__$1,on_write){
return (function (){
...
});})(node_value,map__35908,map__35908__$1,on_write))
);
} else {
...
var G__35921 = jsprops;
(G__35921["defaultValue"] = value);

(G__35921["onChange"] = ((function (G__35921,v,value,on_change){
return (function (p1__35917_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__35917_SHARP_);
});})(G__35921,v,value,on_change))
);
...
var vec__35935 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35935,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35935,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35935,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___36025 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36025 == null)){
} else {
var key_36026 = temp__5739__auto___36025;
(jsprops["key"] = key_36026);
}
...
var temp__5739__auto___36032 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36032 == null)){
} else {
var key_36036 = temp__5739__auto___36032;
reagent.impl.template.oset(jsprops,"key",key_36036);
}
...
var G__35940 = reagent.impl.template.__GT_NativeWrapper();
(G__35940["name"] = c);
...
var G__35941 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__35941) : reagent.impl.template.as_element.call(null,G__35941));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35944){
var G__35945 = cljs.core.first(seq35944);
var seq35944__$1 = cljs.core.next(seq35944);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35945,seq35944__$1);
});
...
break;
default:
var G__36055 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36055;
continue;
...
var n__4607__auto___36057 = a.length;
var i_36058 = (0);
while(true){
if((i_36058 < n__4607__auto___36057)){
(a[i_36058] = reagent.impl.template.as_element((a[i_36058])));

var G__36061 = (i_36058 + (1));
i_36058 = G__36061;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___36063 = a.length;
var i_36064 = (0);
while(true){
if((i_36064 < n__4607__auto___36063)){
var val_36068 = (a[i_36064]);
if(((cljs.core.vector_QMARK_(val_36068)) && ((reagent.impl.template.key_from_vec(val_36068) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36064] = reagent.impl.template.as_element(val_36068));

var G__36069 = (i_36064 + (1));
i_36064 = G__36069;
continue;
} else {
}
...
var ctx = ({});
var vec__35973 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35973,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35973,(1),null);
...
var G__35976 = (cljs.core.count(argv) - first_child);
switch (G__35976) {
case (0):
...
case (1):
var G__35977 = comp;
var G__35978 = jsprops;
var G__35979 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__35977,G__35978,G__35979);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__35976){
